return {
	{
		...
		opts = {
			...
			mappings = {
				...
				["<leader>cT"] = { name = "Tags" },
				["<leader>cTa"] = { name = "Add Tags" },
				["<leader>cTr"] = { name = "Remove Tags" },
				["<leader>cw"] = { name = "Workspace" },
				["<leader>s"] = { name = "Operate Surroundings" },
				["<leader>S"] = { name = "Manage Session" },
				...
				["<leader>y"] = { name = "Yanking and Pasting" },
				["<leader>yy"] = { '"*y', "Yank to Clipboard" },
				["<leader>yp"] = { '"*p', "Paste from Clipboard" },
			},
		},
